...
<body>
        ...
        <div class="card">
            ...
            <div class="details">
                <div class="details-row">
                    ...
                    <span class="status-badge <?php echo e($order->status); ?>"><?php echo e($order->status_label); ?></span>
                </div>
                <div class="details-row">
                    <span class="details-label">Bestand</span>
                    <span class="details-value"><?php echo e($order->pdf_original_name); ?></span>
                </div>
                <div class="details-row">
                    <span class="details-label">Formaat</span>
                    <span class="details-value"><?php echo e($order->format); ?> · <?php echo e($order->page_count); ?> pagina's · <?php if($order->binding_type === 'booklet'): ?>Geniet boekje <?php else: ?> Losbladig (<?php echo e($order->print_side === 'double' ? 'dubbelzijdig' : 'enkelzijdig'); ?>)<?php endif; ?> · <?php echo e($order->quantity ?? 1); ?> <?php echo e(($order->quantity ?? 1) === 1 ? 'exemplaar' : 'exemplaren'); ?></span>
                </div>
                <div class="details-row">
                    <span class="details-label">Totaal</span>
                    <span class="details-value"><?php echo e($order->formatted_total); ?></span>
                </div>
            </div>
            ...
            <div class="next-steps">
                ...
                <ol>
                    <li>Je ontvangt een bevestigingsmail op <strong><?php echo e($order->customer_email); ?></strong></li>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var orderId = '<?php echo e($order->order_number); ?>';

        if (trackedOrders.indexOf(orderId) === -1) {
            gtag('event', 'purchase', {
                transaction_id: orderId,
                currency: 'EUR',
                value: <?php echo e($order->price_total / 100); ?>,
                shipping: <?php echo e($order->price_shipping / 100); ?>
...
<?php /**PATH /Users/elcoroest/Documents/GitHub/printmijnpdf/resources/views/order/complete.blade.php ENDPATH**/ ?>