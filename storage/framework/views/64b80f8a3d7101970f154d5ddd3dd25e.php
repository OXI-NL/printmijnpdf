                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background: linear-gradient(135deg, #eff6ff 0%, #dbeafe 100%); border-radius: 14px; margin-bottom: 25px; border: 1px solid #93c5fd;">
                                <tr>
                                    <td style="padding: 22px; text-align: center;">
                                        ...
                                        <p style="color: #1e40af; font-size: 20px; font-weight: 700; margin: 0 0 16px; font-family: 'SF Mono', Monaco, 'Courier New', monospace; letter-spacing: 1px;"><?php echo e($order->track_trace); ?></p>
                                        <a href="https://postnl.nl/tracktrace/?B=<?php echo e($order->track_trace); ?>&P=<?php echo e($order->address_postcode); ?>&D=NL&T=C" style="display: inline-block; background: #3b82f6; color: white; text-decoration: none; padding: 12px 28px; border-radius: 8px; font-size: 14px; font-weight: 600;">Volg je pakket →</a>
                                    </td>
                                </tr>
                            </table>
                                        ...
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td style="text-align: right;">
                                                    ...
                                                    <p style="color: #1e293b; font-size: 15px; font-weight: 600; margin: 0;"><?php echo e($order->shipped_at->format('d-m-Y')); ?></p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td style="padding: 18px 20px;">
                                        <p style="color: #1e293b; font-size: 14px; margin: 0; line-height: 1.7; font-weight: 500;">
                                            ...
                                            <span style="font-weight: 400; color: #475569;"><?php echo e($order->address_street); ?> <?php echo e($order->address_number); ?><?php echo e($order->address_addition ? ' '.$order->address_addition : ''); ?><br>
                                            <?php echo e($order->address_postcode); ?> <?php echo e($order->address_city); ?></span>
                                        </p>
                                    </td>
                                </tr>
                            </table>
...
<?php /**PATH /Users/elcoroest/Documents/GitHub/printmijnpdf/resources/views/emails/order-shipped.blade.php ENDPATH**/ ?>