                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background: linear-gradient(135deg, #fef2f2 0%, #fff1f2 100%); border-radius: 14px; margin-bottom: 25px; border: 1px solid #fecaca;">
                                <tr>
                                    <td style="padding: 22px;">
                                        ...
                                        <p style="color: #e63946; font-size: 22px; font-weight: 700; margin: 0; font-family: 'SF Mono', Monaco, 'Courier New', monospace; letter-spacing: 0.5px;"><?php echo e($invoice->invoice_number); ?></p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin-bottom: 25px; border: 1px solid #e2e8f0; border-radius: 12px; overflow: hidden;">
                                <tr>
                                    ...
                                    <td style="padding: 14px 16px; background: #f8fafc; border-bottom: 1px solid #e2e8f0; text-align: right;">
                                        <span style="color: #1e293b; font-size: 13px; font-weight: 600;"><?php echo e($order->order_number); ?></span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="padding: 14px 16px; border-bottom: 1px solid #e2e8f0; text-align: right;">
                                        <span style="color: #1e293b; font-size: 13px; font-weight: 500;"><?php echo e($invoice->invoice_date->format('d-m-Y')); ?></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 14px 16px; background: #f8fafc; border-bottom: 1px solid #e2e8f0;">
                                    ...
                                    <td style="padding: 14px 16px; background: #f8fafc; border-bottom: 1px solid #e2e8f0; text-align: right;">
                                        <span style="color: #1e293b; font-size: 13px; font-weight: 500;"><?php echo e($invoice->formatted_excl_btw); ?></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 14px 16px; border-bottom: 1px solid #e2e8f0;">
                                    ...
                                    <td style="padding: 14px 16px; border-bottom: 1px solid #e2e8f0; text-align: right;">
                                        <span style="color: #1e293b; font-size: 13px; font-weight: 500;"><?php echo e($invoice->formatted_btw); ?></span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="padding: 16px; background: #1e293b; text-align: right;">
                                        <span style="color: white; font-size: 16px; font-weight: 700;"><?php echo e($invoice->formatted_total); ?></span>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td bgcolor="#1e293b" style="background: #1e293b; padding: 28px 30px; text-align: center;">
                            ...
                            <p style="color: #475569; font-size: 12px; margin: 20px 0 0;">
                                &copy; <?php echo e(date('Y')); ?> PrintMijnPDF.nl &middot; Alle rechten voorbehouden
                            </p>
                        </td>
                    </tr>
...
<?php /**PATH /Users/elcoroest/Documents/GitHub/printmijnpdf/resources/views/emails/invoice.blade.php ENDPATH**/ ?>